# 通过 `/admin/accounts/add` 热加载 Notion 账号

[← Back to README](../README.md)

> 自 `fix(admin): HandleAddAccount 接受 expected_email 防止 token_v2 误绑用户` 起可用（`pjpjq/notion_manager` PR #3）。
...
## 端到端示例（zantoartieg4@outlook.com）
